...
class WarmupMultiStepLR(torch.optim.lr_scheduler._LRScheduler):
    def __init__(self, optimizer, milestones=(35000, 40000), gamma=0.1, warmup_factor=0.001,
                 warmup_iters=1000, warmup_method="linear", last_epoch=-1,):
        ...
        self.gamma = gamma
        self.warmup_iters = warmup_iters
        self.warmup_factor = 1.0 / self.warmup_iters
        self.warmup_method = warmup_method
        super().__init__(optimizer, last_epoch)
